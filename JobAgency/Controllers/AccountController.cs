...
using JobAgency.Providers;
using JobAgency.Results;
using System.Configuration;
using JobAgency.Messaging;
...
namespace JobAgency.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        private static async Task SendMeMail(RegisterBindingModel model)
        {
            ...
            string htmlBody = $@"<h3>Welcome to The Job Agency </h3> <b> <i> {model.FirstName} </i></b>
                                    <p>Kindly find your Registration details below:</p>
                                 <ul>
